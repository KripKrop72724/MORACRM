...
interface SimpleEditExpenseModalProps {
  open: boolean;
  expense: Expense;
  onClose: () => void;
  onSuccess: () => void;
...
const SimpleEditExpenseModal: React.FC<SimpleEditExpenseModalProps> = ({
  open,
  expense,
  onClose,
  onSuccess,
        ...
        <Box sx={modalStyle}>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            <Box sx={{ mt: 3, display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
              ...
              >
                {isSubmitting ? <CircularProgress size={24} /> : 'Update Expense'}
              </Button>
            </Box>
          </Box>
        </Box>
...
export default SimpleEditExpenseModal;